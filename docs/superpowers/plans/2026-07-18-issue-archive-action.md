...
> **Implementation status (2026-07-18): complete.** Current source, workflow, and acceptance tests are authoritative; the unchecked steps below preserve the original TDD sequence.
